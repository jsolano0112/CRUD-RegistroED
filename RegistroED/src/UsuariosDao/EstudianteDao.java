...
public class EstudianteDao {
   ...
   private Conexion conexion = new Conexion();
    ...
    public ArrayList<Estudiante> leerEstudiante() throws SQLException{
        ...
        try {
            ...
            while(resul.next()){
                ...
                est.setIdA(resul.getInt("idAlumno"));//trae lo que esté en la columna rut y guardelo en set
    ...
    public  boolean actualizarEstudiante(Estudiante alumno) throws SQLException{
        ...
        Connection conn = conexion.conectar();
        try{
           String sql = "UPDATE alumno SET nombresA = ?, apellidoA1 = ?, apellidoA2 = ?, correoA = ? WHERE idAlumno = ?";
           PreparedStatement stmt = conn.prepareStatement(sql);
